...
public class MonteScreenRecorder extends ScreenRecorder
{
    ...
    /*
     ...
     Method description: This method creates new movie file.
     Method parameter: Format fileFormat
     Method return: File new file
     #####################################################################
   */
    @Override
    ...
    /*
     ...
     Method description: This method start recording a movie
     Method parameter: String methodName
     Method return: none
     #####################################################################
   */
    ...
    /*
     ...
     Method description: This method stops recording a movie
